    ...
    fillAxisMeta(data, axisPnt) {
        if (typeof axisPnt === 'string') {
            if (Array.isArray(data)) {
                ...
                data.interval = Math.ceil((data.end - data.begin) / AXIS_LABEL_LIMIT[AXIS_TYPE.DATE]) || 1;
            }
        }
            ...
            data.interval = Math.ceil((data.end - data.begin) / AXIS_LABEL_LIMIT[AXIS_TYPE.NUMBER]) || 1;
        }
        return data;
    }
    getGraphMeta(data) {
